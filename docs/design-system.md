...
| Scrollbar | Custom: schmaler Teal-Verlaufs-Balken (webkit + `scrollbar-color`), Balken „schwebt" über 3px-Rand; nur während des Scrollens sichtbar (`html.scrolling`, 0,9 s Nachlauf), Spurbreite bleibt reserviert; auf Touch-Geräten komplett ausgeblendet (12.08.2026) |
